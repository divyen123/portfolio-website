            ...
            <AnimatePresence>
              {(heroFocusMode || isMobile) && (
                <motion.div
                  ...
                  initial={{ opacity: 1, scaleX: 0.08, y: (!heroFocusMode && isMobile) ? -40 : 0 }}
                  animate={{ opacity: 1, scaleX: 1, y: (!heroFocusMode && isMobile) ? -40 : 0 }}
                  exit={{ opacity: 0, scaleX: 0.08, y: (!heroFocusMode && isMobile) ? -40 : 0 }}
